...
class BallDetector:
    ...
    def infer_model(self, frames):
        """ chay pretrained model qua danh sach cac frames
            ball_track: dsach detected ball points
        """
        ball_track = [(None, None)]*2
        prev_pred = [None, None]
        for num in tqdm(range(2, len(frames))):
            # lay 3 frames lien tiep
            ...
            imgs = np.concatenate((img, img_prev, img_preprev), axis=2) # RGB × 3 = 9 channel
